...
- [ ] Prompt de quiz en `prompts.py` con ejemplo few-shot y esquema JSON.
- [ ] `evaluacion.py`: modelos, validador de esquema, `generar_quiz`,
      `calificar`, validación de respuestas del usuario.
- [ ] Presentación del resultado (nota + detalle por pregunta) en la CLI.
- [ ] Pruebas (abajo).
